...
Rails.application.configure do
  ...
  # Store uploaded files on Cloudinary for persistent storage in production
  ...
  # config.active_job.queue_name_prefix = "moto_wrzutka_api_production"
  ...
  # Use proxy for Active Storage to avoid signed URL expiration
  config.active_storage.resolve_model_to_route = :proxy

  # Configure URL helpers for Render environment

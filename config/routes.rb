...
# auth_url_api_v1_allegro_integration_index GET    /api/v1/allegro_integration/auth_url(.:format)                                                    api/v1/allegro_integration#auth_url
# callback_api_v1_allegro_integration_index POST   /api/v1/allegro_integration/callback(.:format)                                                    api/v1/allegro_integration#callback
#   status_api_v1_allegro_integration_index GET    /api/v1/allegro_integration/status(.:format)                                                      api/v1/allegro_integration#status
